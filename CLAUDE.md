...
| 秋の集中講座 | `autumn-intensive.html` | `page-header--slate` | 時間割枠外（全5日間） | 学科横断・既存の進級制作チーム単位（2026-09-24改訂: 新規混成チーム編成から既存進級制作チーム参加へ、カメラ×AI単一パスからトラックA「カメラ×AI」／トラックB「同時対戦ゲーム」／トラックC「自由テーマ」の3択へ） |
